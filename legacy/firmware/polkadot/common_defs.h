#ifndef __POLKADOT_COMMON_DEFS_H__
#define __POLKADOT_COMMON_DEFS_H__
...
__Z_INLINE uint16_t fpuint64_to_str(char *out, uint16_t outLen,
                                    const uint64_t value, uint8_t decimals) {
  char buffer[30];
