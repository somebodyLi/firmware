...
class Features(protobuf.MessageType):
    ...
    FIELDS = {
        ...
        511: protobuf.Field("serial_no", "string", repeated=False, required=False, default=None),
        512: protobuf.Field("spi_flash", "string", repeated=False, required=False, default=None),
        513: protobuf.Field("initstates", "uint32", repeated=False, required=False, default=None),
        514: protobuf.Field("NFT_voucher", "bytes", repeated=False, required=False, default=None),
        515: protobuf.Field("cpu_info", "string", repeated=False, required=False, default=None),
        516: protobuf.Field("pre_firmware", "string", repeated=False, required=False, default=None),
...
class DeviceInfoSettings(protobuf.MessageType):
    ...
    FIELDS = {
        1: protobuf.Field("serial_no", "string", repeated=False, required=False, default=None),
        2: protobuf.Field("cpu_info", "string", repeated=False, required=False, default=None),
        3: protobuf.Field("pre_firmware", "string", repeated=False, required=False, default=None),
    }
...
class DeviceInfo(protobuf.MessageType):
    ...
    FIELDS = {
        1: protobuf.Field("serial_no", "string", repeated=False, required=False, default=None),
        2: protobuf.Field("spiFlash_info", "string", repeated=False, required=False, default=None),
        3: protobuf.Field("SE_info", "string", repeated=False, required=False, default=None),
        4: protobuf.Field("NFT_voucher", "bytes", repeated=False, required=False, default=None),
        5: protobuf.Field("cpu_info", "string", repeated=False, required=False, default=None),
        6: protobuf.Field("pre_firmware", "string", repeated=False, required=False, default=None),
    }
...
class NFTWriteInfo(protobuf.MessageType):
    ...
    FIELDS = {
        ...
        4: protobuf.Field("name_zh", "string", repeated=False, required=False, default=None),
        5: protobuf.Field("name_en", "string", repeated=False, required=False, default=None),
    }
