...
translations = [
    ...
    "Turn on Bluetooth on both devices. Keep the wallet close to your phone, and click on the detected OneKey Pro device name.",
    "Pair Devices",
    ...
    "Access Wallet",
    "Open the OKX Mobile App, go to Wallet, select \"I already have one\" > \"Hardware wallet\" > \"OneKey\".",
    ...
    "Choose \"TREZOR\", click \"Continue\", select \"Allow once for this session\", and follow the on-screen instructions to export. Input your OneKey wallet PIN when prompted.",
    "Unlock Account",
    "From the list of accounts, select the one you wish to connect and click \"Unlock\".",
    "Open the OKX wallet extension, select \"Import Wallet\" > \"Hardware wallet\" > \"OneKey\".",
    "Install OneKey Bridge",
    "Download and install OneKey Bridge if prompted, then refresh, choose your device, and enter your PIN.",
